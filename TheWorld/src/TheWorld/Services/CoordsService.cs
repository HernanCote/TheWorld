...
namespace TheWorld.Services
{
    ...
    {
        private ILogger<CoordsService> _logger;

        public CoordsService(ILogger<CoordsService> logger)
        {
            _logger = logger;
        }

        public async Task<CoordsServiceResult> Lookup(string location)
        {
            var result = new CoordsServiceResult()
            {
                Success = false,
